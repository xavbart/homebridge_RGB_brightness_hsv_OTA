...
// above header file include setup_run() and main_run() to be executed in setup and loop respectively

const char* ssid = "eeroNet";
const char* password = "compiegne2016";
...
void setup() {
  ...
  // No authentication by default
   ArduinoOTA.setPassword("adminesp32");
